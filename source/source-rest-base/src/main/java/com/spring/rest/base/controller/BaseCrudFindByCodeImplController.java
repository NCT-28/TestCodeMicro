...
public abstract class BaseCrudFindByCodeImplController <T extends BaseEntity> extends BaseSearchCrudImplController<T> implements BaseFindByCodeControler<T> {
    protected BaseCrudFindByCodeImplController(WhereServiceSQL<T, UUID> service) {
        super(service);
    }
    /**
     * Tìm kiếm theo mã
